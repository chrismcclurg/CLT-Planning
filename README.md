...
## Preparation
**Download [Project Malmo](https://github.com/microsoft/malmo).** Make sure that the downloaded version corresponds to the version of Python. We found Python 3.6 to be the easiest to use.   
